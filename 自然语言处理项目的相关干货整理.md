...
## Automatic Summarisation(自动摘要)
  * ****`PAPER`**** [A Neural Attention Model for Sentence Summarization](https://aclweb.org/anthology/D15-1044)
    - 由Facebook首先提出的基于神经网络的文本摘要生成模型-ABS，并提出了改进模型ABS+
  * ****`PAPER`**** [A Reinforced Topic-Aware Convolutional Sequence-to-SequenceModel for Abstractive Text Summarization](https://arxiv.org/pdf/1805.03616.pdf)
    - 由腾讯知文团队、苏黎世联邦理工学院、哥伦比亚大学和腾讯 AI Lab 的研究者联合提出的，基于卷积神经网络的强化感知主题序列到序列的文本摘要生成模型-ConvS2S。
  * ****`PAPER`**** [Abstractive Text Summarization using Sequence-to-sequence RNNs and Beyond](https://arxiv.org/abs/1602.06023)
    - 由IBM Watson实验室提出。
  * ****`PAPER`**** [TextRank: Bringing order into texts](https://web.eecs.umich.edu/~mihalcea/papers/mihalcea.emnlp04.pdf)
